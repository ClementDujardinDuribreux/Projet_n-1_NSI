...
def placement_pion_depart(dico:dict) -> dict:
    ...
    for pion in dico_placement_depart_J1.keys():
        placement_pion(dico, pions_en_nombre(pion, 1), pos(dico_placement_depart_J1[pion]))
    for pion in dico_placement_depart_J2.keys():
        placement_pion(dico, pions_en_nombre(pion, 2), pos(dico_placement_depart_J2[pion]))
    return dico
